...
export const fallbackProfile: ProfileResponse = {
  ...
  tagline:
    'Architecting distributed systems, shipping AI infrastructure, and engineering production-grade services.',
  years_of_experience: 6,
  professional_summary:
    'Backend engineer specializing in building scalable systems, AI services, and distributed architectures. I care about the full product lifecycle — from first whiteboard sketch to the 3AM pager. My favorite deploys are the boring ones.',
  skills: [
    'Python',
    'Go',
    'Rust',
